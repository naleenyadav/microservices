...
* The original package name 'com.naleen.microservices.convert-currency-service' is invalid and this project uses 'com.naleen.microservices.convertcurrencyservice' instead.
